...
// 输入后1秒或失去焦点时保存
editor.value.on('update', useDebounceFn(({ editor }: EditorEvents['update']) => handleDebouncedSave(eventId.value, editor.getHTML())))
...
const handleSet = () => {
  editor.value.commands.setContent('<p><span data-type=\"mention\" data-id=\"@1\">114514</span></p>')
}
</script>
